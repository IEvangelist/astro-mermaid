/**
 * Client-side only implementation (extracted from original integration)
 * This module maintains the existing client-side rendering behavior unchanged
 */

/**
 * Remark plugin to transform mermaid code blocks at the markdown level
 * This is the existing implementation moved to a separate module (unchanged)
 */
...
/**
 * Generate the client-side mermaid script
 * This is the existing implementation moved to a separate function (unchanged)
 */
...
/**
 * Generate the CSS for mermaid diagrams
 * This is the existing implementation moved to a separate function (unchanged)
 */
export function generateMermaidCSS() {
  return `
